...
function preload(){
    ...
    myFont = loadFont('CODE/typefaces/FormaDJRTextMedium.ttf');

    // ---------------------------------------------------------------

    let face1 = loadImage('/CODE/BW/emotion1.png');
    let face2 = loadImage('/CODE/BW/emotion2.png');
    let face3 = loadImage('/CODE/BW/emotion3.png');
    let face4 = loadImage('/CODE/BW/emotion4.png');
    let face5 = loadImage('/CODE/BW/emotion5.png');
    let face6 = loadImage('/CODE/BW/emotion6.png');
    let face7 = loadImage('/CODE/BW/emotion7.png');
